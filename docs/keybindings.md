...
| `tg` | track **google** | Search the targeted track in the default browser — **the artist's name then the title** — through `xdg-open`. Like `ag`, it needs no card: a track outside the catalog is searchable too (Joel, 2026-09-23) | session | ✅ |
