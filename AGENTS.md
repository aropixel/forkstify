...
| `.github/workflows/release.yml`, `packaging/aur/` | La distribution : un tag `v*` publie un binaire Linux en release, et `packaging/aur/forkstify-bin` le pose sur Arch. Marche à suivre dans `packaging/aur/README.md`. |
...
- **L'application vectorise elle-même** : une fiche générée naît avec son
